...
const Map<String, UniversalWizardConfig> kUniversalWizardConfigs = {
  'expert_cleaning': UniversalWizardConfig(
    ...
    step1SubTypes: [
      ...
      MapEntry('guesthouse', 'sub_cleaning_guesthouse'),
  ...
  'expert_moving': UniversalWizardConfig(
    ...
    step1SubTypes: [
      ...
      MapEntry('tuktuk', 'sub_moving_tuktuk'),
      MapEntry('other', 'symptom_other'),
    ],
  ...
  'expert_tutoring': UniversalWizardConfig(
    ...
    step1SubTypes: [
      ...
      MapEntry('lang_th', 'sub_tutor_lang_th'),
      MapEntry('lang_ja', 'sub_tutor_lang_ja'),
      ...
      MapEntry('traditional_dance', 'sub_tutor_traditional_dance'),
      MapEntry('buddhism', 'sub_tutor_buddhism'),
      MapEntry('other', 'symptom_other'),
    ],
  ...
  'expert_vehicle': UniversalWizardConfig(
    ...
    step1SubTypes: [
      ...
      MapEntry('tuktuk', 'sub_vehicle_tuktuk'),
      MapEntry('other', 'symptom_other'),
    ],
    step2ChoiceType: Step2ChoiceType.none,
    step2Labels: [],
