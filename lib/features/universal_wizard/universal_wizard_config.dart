...
const Map<String, UniversalWizardConfig> kUniversalWizardConfigs = {
  ...
  'expert_beauty': UniversalWizardConfig(
    ...
    step1SubTypes: [
      MapEntry('general', '일반 뷰티/헬스'),
      MapEntry('care', '헬스/케어'),
      MapEntry('nail_makeup', '네일/메이크업'),
      MapEntry('other', '기타'),
    ],
    step2ChoiceType: Step2ChoiceType.none,
    step2Labels: [],
  ...
  'expert_event': UniversalWizardConfig(
    ...
    step1SubTypes: [
      MapEntry('party_planning', '파티 기획'),
      MapEntry('sound_light_rental', '음향/조명 렌탈'),
      MapEntry('helper', '도우미'),
      MapEntry('other', '기타'),
    ],
    step2ChoiceType: Step2ChoiceType.singleList,
  ...
  'expert_garden': UniversalWizardConfig(
    ...
    step1SubTypes: [
      MapEntry('lawn', '잔디 깎기'),
      MapEntry('landscape', '조경/식재'),
      MapEntry('tree_trim', '나무 전지'),
      MapEntry('other', '기타'),
    ],
    step2ChoiceType: Step2ChoiceType.scaleSML,
    step2Labels: ['S', 'M', 'L'],
